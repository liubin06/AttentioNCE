...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_pos', default=1, type=float, help='Scaling factor for positive samples')
    parser.add_argument('--d_neg', default=1, type=float, help='Scaling factor for negative samples')
